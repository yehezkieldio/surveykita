<x-layouts.admin heading="Kategori Pertanyaan" eyebrow="Manajemen Konten">
    <x-slot:actions>
        <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
            <x-ui.button href="{{ route('admin.categories.export.excel') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button href="{{ route('admin.categories.export.pdf') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button href="{{ route('admin.categories.create') }}" variant="teal" size="sm" class="w-full sm:w-auto">
