<x-layouts.admin heading="Instrumen Evaluasi" eyebrow="Pengaturan Formulir">
    <x-slot:actions>
        <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
            <x-ui.button id="forms-export-excel" href="{{ route('admin.forms.export.excel') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button id="forms-export-pdf" href="{{ route('admin.forms.export.pdf') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button href="{{ route('admin.forms.create') }}" variant="teal" size="sm" class="w-full sm:w-auto">
