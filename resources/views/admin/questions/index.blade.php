<x-layouts.admin heading="Butir Pertanyaan" eyebrow="Database Instrumen">
    <x-slot:actions>
        <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
            <x-ui.button id="questions-export-excel" href="{{ route('admin.questions.export.excel') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button id="questions-export-pdf" href="{{ route('admin.questions.export.pdf') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
