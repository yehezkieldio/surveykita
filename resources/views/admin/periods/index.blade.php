<x-layouts.admin heading="Periode Evaluasi" eyebrow="Pengaturan Jadwal">
    <x-slot:actions>
        <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
            <x-ui.button href="{{ route('admin.periods.export.excel') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button href="{{ route('admin.periods.export.pdf') }}" variant="secondary" size="sm" class="w-full sm:w-auto">
            ...
            <x-ui.button href="{{ route('admin.periods.create') }}" variant="teal" size="sm" class="w-full sm:w-auto">
