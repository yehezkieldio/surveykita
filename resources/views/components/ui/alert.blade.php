@if (session('success'))
    <div class="mb-8 flex items-center gap-x-3 border border-teal-100 bg-teal-50/50 p-4 text-sm text-teal-800 animate-reveal">
...
@if (session('error'))
    <div class="mb-8 flex items-center gap-x-3 border border-red-100 bg-red-50/50 p-4 text-sm text-red-800 animate-reveal">
...
@if (session('status'))
    <div class="mb-8 flex items-center gap-x-3 border border-zinc-200 bg-white p-4 text-sm text-zinc-800 animate-reveal">
