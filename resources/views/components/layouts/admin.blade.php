    ...
    <div class="min-h-full bg-zinc-50">
        <aside class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col lg:border-r lg:border-zinc-800 lg:bg-zinc-950 lg:text-white">
            <div class="flex h-full flex-col px-6 py-8">
                <div class="mb-10 flex h-8 shrink-0 items-center">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 font-display text-xl font-bold tracking-tight text-white">
                        SurveyKita
                    </a>
                </div>
                            ...
                            <ul role="list" class="flex flex-col gap-y-1">
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        icon="house"
                                        class="{{ request()->routeIs('admin.dashboard') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Dashboard
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        icon="users"
                                        class="{{ request()->routeIs('admin.students.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Mahasiswa
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        icon="calendar"
                                        class="{{ request()->routeIs('admin.periods.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Periode
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        class="{{ request()->routeIs('admin.forms.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Form Evaluasi
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        icon="tag"
                                        class="{{ request()->routeIs('admin.categories.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Kategori
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        class="{{ request()->routeIs('admin.questions.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Pertanyaan
                                    </x-ui.nav-link>
                                </li>
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        class="{{ request()->routeIs('admin.results.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Hasil Evaluasi
                                    </x-ui.nav-link>
                                </li>
                            ...
                            <ul role="list" class="flex flex-col gap-y-1">
                                <li>
                                    <x-ui.nav-link
                                        ...
                                        icon="user"
                                        class="{{ request()->routeIs('admin.profile.*') ? 'border-l-2 border-teal-500 bg-zinc-900 text-teal-400' : 'border-l-2 border-transparent text-zinc-400 hover:bg-white/5 hover:text-white' }} rounded-none pl-3"
                                    >
                                        Profil Saya
                                    </x-ui.nav-link>
                                </li>
        ...
        <div class="lg:hidden">
            ...
            <div class="sticky top-0 z-40 flex items-center gap-3 border-b border-zinc-200 bg-white/95 px-4 py-3 backdrop-blur-sm sm:px-6">
                <label for="admin-mobile-nav" class="inline-flex h-10 w-10 cursor-pointer items-center justify-center border border-zinc-200 bg-white text-zinc-950 transition-colors hover:bg-zinc-100">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-400">Admin Console</p>
                </div>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
            ...
            <label for="admin-mobile-nav" class="pointer-events-none fixed inset-0 z-40 bg-zinc-950/45 opacity-0 transition-opacity duration-300 peer-checked:pointer-events-auto peer-checked:opacity-100"></label>
            ...
            <aside class="fixed inset-y-0 left-0 z-50 flex w-[18rem] max-w-[85vw] -translate-x-full flex-col border-r border-zinc-800 bg-zinc-950 text-white transition-transform duration-300 peer-checked:translate-x-0">
                <div class="flex items-center justify-between border-b border-zinc-900 px-5 py-4">
                    <div>
                        ...
                        <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-500">Admin Console</p>
                    </div>
                    <label for="admin-mobile-nav" class="inline-flex h-9 w-9 cursor-pointer items-center justify-center border border-zinc-800 text-zinc-400 transition-colors hover:border-zinc-700 hover:text-white">
                ...
                <div class="flex-1 overflow-y-auto px-5 py-6">
                    <div>
                        <p class="mb-4 text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-500">Admin Console</p>
                        <nav>
                            <ul role="list" class="flex flex-col gap-y-1">
                                <li>
                                    <x-ui.nav-link
        ...
        <main class="w-full flex-1 lg:pl-72">
            <div class="mx-auto max-w-full overflow-hidden px-4 py-8 sm:px-6 lg:px-12">
