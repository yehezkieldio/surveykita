...
<x-layouts.app :title="$title ?? $heading">
    <div class="flex min-h-full">
        {{-- Sidebar --}}
        <aside class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col lg:border-r lg:border-zinc-800 lg:bg-zinc-950 lg:text-white h-screen overflow-hidden">
            <div class="flex h-full flex-col px-6 py-8">
                <div class="flex h-8 shrink-0 items-center mb-10">
                    <a href="{{ route('admin.dashboard') }}" class="font-display text-xl font-bold tracking-tight text-white flex items-center gap-2">
                        SurveyKita
                    </a>
                </div>

                <div class="flex flex-1 flex-col gap-y-8 overflow-hidden">
                    <div>
