    ...
    <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <input id="remember" name="remember" type="checkbox" class="h-4 w-4 rounded-none border-zinc-300 text-zinc-950 focus:ring-zinc-950">
                <label for="remember" class="ml-3 text-sm text-zinc-600">Ingat saya</label>
            </div>
        </div>
        ...
        <div class="mt-8">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm font-medium leading-6">
                    <span class="bg-white px-6 text-zinc-400 font-mono text-[10px] uppercase tracking-widest">Atau masuk dengan</span>
                </div>
            </div>

            <div class="mt-6">
                <x-ui.button href="{{ route('auth.google.redirect') }}" variant="secondary" class="w-full gap-3">
