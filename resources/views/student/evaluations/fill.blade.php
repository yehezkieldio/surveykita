    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('student.evaluations.submit', $form) }}" class="space-y-6">
            ...
            @foreach ($form->questions as $question)
                <div class="rounded-none border border-zinc-200 bg-white p-6 transition-all duration-300 hover:border-zinc-300">
                    ...
                    <div class="mt-4 grid gap-3 sm:grid-cols-5">
                        @foreach ([1 => 'Sangat Tidak Puas', 2 => 'Tidak Puas', 3 => 'Cukup Puas', 4 => 'Puas', 5 => 'Sangat Puas'] as $score => $label)
                            <label class="flex items-center gap-3 rounded-none border border-zinc-200 px-4 py-2.5 text-xs text-zinc-700 hover:bg-zinc-50 cursor-pointer transition-all duration-200 select-none">
                                <input 
                                    type="radio" 
            ...
            <div class="rounded-none border border-zinc-200 bg-white p-6">
