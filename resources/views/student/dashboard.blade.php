<x-layouts.student heading="Dashboard Mahasiswa" eyebrow="Halo, {{ Auth::user()->name }}">
    <div class="grid gap-6 sm:grid-cols-2">
        <x-ui.card class="relative overflow-hidden group">
            ...
            <div class="mt-4 flex items-baseline gap-2">
                <span class="text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">{{ $activeFormCount }}</span>
        ...
        <x-ui.card class="relative overflow-hidden group">
            ...
            <div class="mt-4 flex items-baseline gap-2">
                <span class="text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">{{ $submissionCount }}</span>
    ...
    <div class="mt-12">
        <h3 class="mb-6 text-sm font-bold uppercase tracking-[0.2em] text-zinc-400">Tindakan Selanjutnya</h3>
    ...
    <div class="mt-12 grid gap-8 lg:grid-cols-2">
        <div>
            <h3 class="mb-6 text-sm font-bold uppercase tracking-[0.2em] text-zinc-400">Aktivitas Saya</h3>
            <div class="divide-y divide-zinc-200 border-t border-zinc-200">
                <a href="{{ route('student.evaluations.index') }}" class="group flex items-center justify-between py-4 transition-colors hover:bg-zinc-50/50">
                    <div class="flex min-w-0 items-center gap-4">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 transition-colors group-hover:bg-zinc-950 group-hover:text-white">
                    ...
                    <svg class="h-5 w-5 shrink-0 text-zinc-300 transition-colors group-hover:text-zinc-950" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>
                </a>
        ...
        <div class="rounded-lg border border-zinc-200 bg-white p-6">
            ...
            <div class="mt-6 space-y-4">
                <div class="flex items-center justify-between border-b border-zinc-100 py-2">
                ...
                <div class="flex items-center justify-between border-b border-zinc-100 py-2">
                    ...
                    <span class="text-right text-sm text-zinc-950">{{ Auth::user()->student?->study_program ?? '-' }}</span>
                </div>
